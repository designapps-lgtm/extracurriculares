...
const NAV_GROUPS = [
  {
    id: "overview",
    label: "Resumen",
    items: [{ path: "/admin/dashboard", label: "Dashboard", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001 1v-4a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" }],
  },
  {
    id: "operations",
    label: "Operación diaria",
    items: [
      { path: "/admin/attendance", label: "Asistencias", icon: "M3 13l4-4m0 0l4 4m-4-4v10m8-6l4 4m0 0l-4-4m4 4V3" },
      { path: "/admin/classes", label: "Clases", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
      { path: "/admin/schedules", label: "Horarios", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002-2z" },
      { path: "/admin/transfers", label: "Traslados", icon: "M9 13h6m2 0-2-2m2 2-2 2M7 13h.01M4 6h16M4 18h16" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/secretaries", label: "Secretarias", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a2 2 0 01.293.707V19a2 2 0 01-2 2z" },
    ],
  },
  {
    id: "configuration",
    ...
    items: [
      ...
      { path: "/admin/assignments", label: "Oferta académica", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  ...
  return (
    <div className="space-y-3">
      {NAV_GROUPS.map((group) => {
        ...
        const active = group.items.some((item) => location.pathname.startsWith(item.path));
        return (
          <section key={group.id}>
            <button type="button" onClick={() => toggleGroup(group.id)} className="w-full flex items-center justify-between px-3 mb-1 text-[11px] uppercase tracking-wider font-semibold text-surface-500 hover:text-surface-300">
...
export default function AdminLayout() {
  ...
  if (loading) {
    return <div className="min-h-screen min-h-[100dvh] bg-surface-50 dark:bg-surface-950 flex items-center justify-center"><div className="animate-spin w-8 h-8 border-2 border-brand-500 border-t-transparent rounded-full" /></div>;
  }
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-surface-50 dark:bg-surface-950 flex">
      <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-surface-900 dark:bg-surface-950 text-surface-100 shrink-0">
        <div className="px-6 py-5 border-b border-surface-800"><Link to="/admin/dashboard" className="inline-flex items-center gap-2"><Logo chip alt="Extracurriculares" className="h-8 w-auto" /><span className="font-display font-bold text-lg text-white">Admin Panel</span></Link></div>
