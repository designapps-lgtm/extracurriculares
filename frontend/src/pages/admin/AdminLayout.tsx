...
const NAV_GROUPS = [
  {
    id: "overview",
    label: "Resumen",
    items: [{ path: "/admin/dashboard", label: "Panel de control de Extracurriculares", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001 1v-4a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" }],
  },
  {
    id: "operations",
    ...
    items: [
      ...
      { path: "/admin/transfers", label: "Traslados Extracurriculares", icon: "M9 13h6m2 0-2-2m2 2-2 2M7 13h.01M4 6h16M4 18h16" },
  ...
  },
  {
    ...
    label: "Personas",
    items: [
      { path: "/admin/students", label: "Estudiantes Extracurriculares", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" },
      { path: "/admin/teachers", label: "Profesores Extracurriculares", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
  ...
  },
  {
    ...
    label: "Configuración",
    items: [
      { path: "/admin/disciplines", label: "Disciplinas Extracurriculares", icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" },
      { path: "/admin/assignments", label: "Oferta académica Extracurriculares", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
